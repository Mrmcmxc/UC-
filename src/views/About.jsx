...
//             The Universal Collective is a remarkable initiative that leverages the power of blockchain technology to offer valuable support to artists and charities.
//             </p>
...
import divider from "../assets/images/bg12.jpg"
...
const About = () => {
  return (
    <div>
      <div className="w-4/5 m-auto text-white flex flex-row justify-center items-start">
        <div className=" w-full lg:w-1/2 p-8">
        <div>
              <h2 className="text-3xl font-extrabold text-white sm:text-4xl">What is The Universal Collective?</h2>
              <p className="mt-4 text-lg text-white">
              The Universal Collective is a remarkable initiative that leverages the power of blockchain technology to offer valuable support to artists and charities.</p>
              <h2 className="mt-4 text-lg leading-6 font-medium text-white">Our Mission</h2>
              <p className="mt-2text-base text-gray-500">Our mission is to create a vibrant community of creators who are passionate about using their talents for good. We will provide a variety of tools and resources to help artists succeed, including marketing and promotional support, access to a community of fellow creators, and educational resources to help them improve their craft. Our goal is to make a positive impact on society, one NFT at a time.</p>
        </div>
        </div>
        <div className=" w-1/2">
          <img src={uc2}></img>
        ...
        <div className=" w-4/5 m-auto p-8">
          <h2 className=" text-center text-3xl font-bold text-white mb-8">Our Values</h2>
          <ul className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div>
        <img src={divider} className="w-full h-[500px]"/>
      </div>
        ...
        <div className=" w-full lg:w-1/2 p-8">
        <div>
              <h2 className="text-3xl font-extrabold text-white sm:text-4xl text-center">What is The Universal Collective?</h2>
