...
const PlaceBid = () => {
   ...
   return (
    ...
    <div className={`z-10 fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-black bg-opacity-50  transform transition-transform duration-300 ${bidModal}`}>
        ...
        <div className="z-10 bg-[#151c25] shadow-md shadow-[#2574bd] rounded-lg w-11/12 sm:w-2/5 h-7/12 p-6">
            ...
            <form on onSubmit={handleSubmit} className='flex flex-col'>
                ...
                <button type='submit' className=' flex justify-center items-center w-full text-white text-md bg-[#0047a5] mt-5 py-2 px-5 rounded-full drop-shadow-md border border-transparent hover:bg-transparent hover:text-white hover:border hover:border-[#12c6fd] focus:outline-none focus:ring-0'>Place Bid</button>
