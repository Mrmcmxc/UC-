...
//         <p className="text-xl uppercase text-white"> {title ? title : 'Live Auctions'}</p>
//         <input
//           type="text"
//           placeholder="Search"
//           className="w-48 rounded-md px-2 py-1 text-black"
//           value={searchTerm}
...
//         <img src={auction.image} alt={auction.name} className="object-cover  p-4 w-full h-80" />
//       </Link>
//       <div className="shadow-md shadow-gray-900 grid grid-cols-2 justify-between items-center text-gray-300 px-4">
//         <div className="flex flex-col items-start py-2 px-1">
//           <span>Current Bid</span>
...
//         <div className='p-2 col-start-1 col-span-4'>
//           {auction.tokenid % 2 == 0 ? (
//             <button className="bg-blue-700 w-full h-[40px] p-2 text-center font-bold font-mono rounded-md hover:text-[#ffffff]" onClick={() => setGlobalState('priceModal', 'scale-100')}>
//               Place a Bid
//             </button>
//           ) : (
//             <button className="bg-green-700 w-full h-[40px] p-2 text-center font-bold font-mono rounded-md hover:text-[#ffffff]" onClick={() => setGlobalState('bidModal', 'scale-100')}>
//               Buy Now
//             </button>
//           )}
//         </div>
